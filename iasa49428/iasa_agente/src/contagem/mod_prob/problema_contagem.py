...
class ProblemaContagem(Problema):
    ...
    - Exemplo: Se o valor inicial for 0, o valor final for 9 e os incrementos possíveis forem [1, 2], então a solução deverá ser: 0, 2, 4, 6, 8, com os incrementos 2, 2, 2, 2, 1.
    """
