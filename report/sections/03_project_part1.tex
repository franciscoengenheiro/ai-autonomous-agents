...
\begin{itemize}[topsep=0pt,itemsep=0pt,partopsep=0pt, parsep=0pt]
    ...
    \item \tb{Visibilidade}: Menos visibilidade representa menos acoplamento;
...
\begin{itemize}[topsep=0pt,itemsep=0pt,partopsep=0pt, parsep=0pt]
    \item \tb{Abstração};
    \item \tb{Modularização}: Ao qual está associado a decomposição e o encapsulamento dos diversos módulos;
...
\begin{itemize}[topsep=0pt,itemsep=0pt,partopsep=0pt, parsep=0pt]
    ...
    \item \tb{Implementação}: Código fonte que implementa o sistema.
\end{itemize}
